# Graph Report - Kapak  (2026-08-25)

## Corpus Check
- 24 files · ~27,821 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 229 nodes · 412 edges · 12 communities
- Extraction: 91% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0d811414`
...
2. `isikPaneliniKur()` - 10 edges
3. `idIleModelBul()` - 10 edges
...
### Community 0 - "ui.js"
Cohesion: 0.14
Nodes (32): idIleOrtamBul(), aralikEtiketiniGuncelle(), arayuzuBaslat(), bildir(), durum, goruntuGuncellemesiPlanla(), guncellemeyiUygula(), hexMetni() (+24 more)
...
Cohesion: 0.13
Nodes (25): citaliKapakGrubuOlustur(), duzKapakGeometrisiOlustur(), kapakGeometrisiTemizle(), kapakGrubuOlustur(), glbKapakGrubuOlustur(), glbSablonunuYukle(), onbellek, yukleyici (+17 more)
